      ...
      <Container>
        <div style={{ display: "flex", marginBottom: "25px" }}>
          ...
          <div className="support-us">
            <p style={{ color: "#807e87", fontWeight: "bolder", lineHeight: "30px" }}>
        ...
        <div style={{ display: "flex", position: "relative",top:"-25px" }}>
          <div className="main-about">
            <p className="lead" style={{ margin: "50px" }}>
              <button className="woori-button" onClick={() => { window.open("https://github.com/WooriVeryGood") }}>
                WooriVeryGood
              </button><br></br>
              <strong style={{ fontSize: "32px" }}>
                "답변 받았습니다!" 는 재학생 개발팀 @우리잘했조가 개발한, <br></br>
                북경대학교 재학 한국인 유학생들을 위한 <br></br>
                수강정보 공유 커뮤니티입니다.
              </strong>
            </p>
            <p style={{ margin: "50px", color: "#dfdee2", marginTop: "90px" }}>
              본 웹사이트는 북경대학교 학우들의 수강평가 공유 및 익명 커뮤니티 웹사이트이며,<br></br>
          ...
          <div style={{ display: "inline-block", position: "relative", left: "60%", width: "40%", marginTop: "30px" }}>
            <div className="second-about">
              <p style={{ fontSize: "20px", margin: "30px", fontWeight: "bolder" }}>
            ...
            <div className="third-about">
              ...
              <p style={{ fontSize: "20px", margin: "30px", marginTop: "14px", fontWeight: "bolder" }}>
