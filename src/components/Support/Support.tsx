  ...
  return (
    <PageView>
      <Container>
        ...
        <p>
          <strong>
            💸 북경대학교 한국인 학우분들을 위해 개발된 본 웹사이트는, 현재
            개발팀장의 사비로 전적 운영되고 있습니다.
          </strong>
          <ul>
            <br></br>
            <li>
        ...
        <p>
          ...
          <ul>
            <br></br>
            <li>
              저희 팀은 앞으로도 학우분들을 위해 웹사이트의 신규 기능 개발,
              유지보수에 힘 쓸 예정입니다. 현 팀원이 졸업하더라도, 몇년이고 저희
              학교에 한국인 유학생이 남아 있는 한 웹사이트가 유지될 수 있도록
              말이죠!
            </li>
            <br></br>
            <li>
            ...
            <li>
              ...
              개발자 학우들의 나이챠/밤샘개발용 에너지 음료 등 구매 비용으로 소중하게 사용될 예정입니다. 기부자
              여러분은 언제나 저희 팀원을 찾아 기부금 사용 내역을 요청 &
              확인하실 수 있습니다.
            </li>
            <br></br>
            <li>
